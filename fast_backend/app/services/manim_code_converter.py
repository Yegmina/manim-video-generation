...
class ManimCodeConverter:
    ...
    def convert_code(self, code: str) -> str:
        ...
        # Fix invalid portrait config patterns generated by models
        converted_code = self._fix_portrait_config_patterns(converted_code)
    ...
    def _fix_portrait_config_patterns(self, code: str) -> str:
        """Rewrite invalid self.camera.config portrait assignments to valid module-level config."""
        replacements = {
            "self.camera.config.pixel_width": "config.pixel_width",
            "self.camera.config.pixel_height": "config.pixel_height",
            "self.camera.config.frame_width": "config.frame_width",
            "self.camera.config.frame_height": "config.frame_height",
        }
